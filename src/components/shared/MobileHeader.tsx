...
export default function MobileHeader() {
  ...
  return (
    <>
      <header className="flex md:hidden items-center bg-transparent p-4 pb-2 justify-between absolute w-full z-50">
              ...
              if (item.onClick) {
                return (
                  <button
                    ...
                    className="flex items-center gap-4 px-4 py-3 rounded-lg transition-colors duration-200 w-full text-left text-slate-300 hover:bg-slate-800 hover:text-white"
                  >
